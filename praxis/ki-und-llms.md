...
{numref}`ml-beispiel-ausschnitt` illustriert diesen Ausschnitt. Die Verbindungen zwischen den Knoten haben Gewichte, die bemessen, wie wichtig die jeweilig weitergegebene Information für den Folgeknoten ist.
...
Die Berechnung des ersten Knotens erfolgt als Summe der eingehenden Knotenverbindungen, entsprechend ihrer Gewichtungen, wie in {numref}`ml-beispiel-1` gezeigt.
